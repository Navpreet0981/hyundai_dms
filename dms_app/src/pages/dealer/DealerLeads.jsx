...
// Reusable button style constants — avoids repeating long className strings
...
export default function DealerLeads() {
  ...
  // Fetch all leads scoped to this dealer — backend filters by dealer ID from JWT
              ...
              <tbody>
                {leads.length === 0 ? (
                  ...
                  <tr key={l.customerId} className="apple-table-row">
                    ...
                    {/* Quick status update buttons — each calls updateStatus with the target status */}
                    <td className="apple-table-cell">
